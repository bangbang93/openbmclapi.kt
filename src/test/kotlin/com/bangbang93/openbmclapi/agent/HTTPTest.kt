        ...
        describe("PartialContent 插件") {
          it("应该安装 PartialContent 插件") {
            testApplication {
              ...
              routing {
                get("/test-content") { call.respondText("0123456789", ContentType.Text.Plain) }
              }
        ...
        describe("Compression 插件") {
          it("应该支持 gzip 压缩") {
            testApplication {
              ...
              routing {
                get("/test-compression") { call.respondText("这是一个很长的文本内容，应该被压缩以节省带宽。".repeat(100)) }
              }
        ...
        describe("插件集成测试") {
          it("所有插件应该协同工作") {
            testApplication {
              ...
              client
                  .get("/integration-test.css") { header(HttpHeaders.AcceptEncoding, "gzip") }
                  .apply {
                    // 应该同时支持压缩和缓存
                    status shouldBe HttpStatusCode.OK
