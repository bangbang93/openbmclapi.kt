...
data class WebdavStorageConfig(
    ...
    companion object {
        fun fromMap(config: Map<String, String>): WebdavStorageConfig {
            ...
            val basePath =
                config["basePath"] ?: throw IllegalArgumentException("WebDAV basePath 是必需的")
...
data class AlistWebdavStorageConfig(
    ...
    companion object {
        fun fromMap(config: Map<String, String>): AlistWebdavStorageConfig {
            ...
            val basePath =
                config["basePath"] ?: throw IllegalArgumentException("Alist WebDAV basePath 是必需的")
...
/** MinIO 存储配置 */
data class MinioStorageConfig(val url: String, val internalUrl: String? = null) {
    init {
    ...
    companion object {
        fun fromMap(config: Map<String, String>): MinioStorageConfig {
            ...
            return MinioStorageConfig(url = url, internalUrl = config["internalUrl"])
        }
    }
}
...
data class OssStorageConfig(
    ...
    companion object {
        fun fromMap(config: Map<String, String>): OssStorageConfig {
            val accessKeyId =
                config["accessKeyId"] ?: throw IllegalArgumentException("OSS accessKeyId 是必需的")
            val accessKeySecret =
                config["accessKeySecret"]
                    ?: throw IllegalArgumentException("OSS accessKeySecret 是必需的")
