...
class FileStorage(private val cacheDir: String) : IStorage {
    ...
    override suspend fun writeFile(path: String, content: ByteArray, fileInfo: FileInfo) = withContext(Dispatchers.IO) {
    ...
    override suspend fun getMissingFiles(files: List<FileInfo>): List<FileInfo> = withContext(Dispatchers.IO) {
    ...
    override suspend fun gc(files: List<FileInfo>): GCCounter = withContext(Dispatchers.IO) {
    ...
    override suspend fun serveFile(hashPath: String, call: ApplicationCall, name: String?): ServeResult {
